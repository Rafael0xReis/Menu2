...
bool ImGui::Tab(const char* label, bool selected, float x)
{
    ...
    ImVec2 pos = window->DC.CursorPos;
    const ImRect bb(pos, pos + ImVec2(x, 51));
    ImGui::ItemSize(ImVec2(x, 51), style.FramePadding.y);
    ...
    if (selected == false)
    {
        draw->AddRectFilled(pos, ImVec2(pos.x + x, pos.y + 51), ImColor(40, 145, 40));
    }
    else if (selected)
    {
        draw->AddRectFilled(pos, ImVec2(pos.x + x, pos.y + 51), ImColor(20, 125, 20));
        draw->AddTriangleFilled(ImVec2(pos.x + ((x / 2) - 10), pos.y + 51), ImVec2(pos.x + (x / 2), pos.y + 41), ImVec2(pos.x + ((x / 2) + 10), pos.y + 51), ImColor(58, 58, 58));
    }

    draw->AddText(ImVec2(pos.x + ((x / 2) - (label_size.x / 2)), pos.y + ((51 / 2) - (label_size.y / 2))), ImColor(255, 255, 255), label);
