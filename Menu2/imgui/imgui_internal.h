...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginFeaturesChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          Tab(const char* label, bool selected, float x);
    // Fonts, drawing
